...
if ret == 0:
	...
	run_cmd("%s %s yum install -y libcap-devel libaio-devel.x86_64 protobuf-devel.x86_64 libnl3-devel PyYAML glibc-devel.i686 protobuf-python.x86_64 lsof libnet-devel python-ipaddr" % (SSH, droplet.ip_address))
